...
public class UserService {
	...
	public User validateUserByEmail(String email, String password) {
		...
		try {
			User user = userRepository.validateUserByEmail(email, password);
			return user;
		} catch (NoResultException e) {
			return null;
		}
	...
	public User validateUserByMobile(long mobile, String password) {

		try {
			User user = userRepository.validateUserByMobile(mobile, password);
			return user;
		} catch (NoResultException e) {
			return null;
		}
