...
public class CarController {
	...
	public ResponseEntity<ResponseStructure<Car>> deleteCar(@RequestParam(name = "userId") int carId, @RequestParam(name = "userId") int userId) {
		Car deletedCar = carService.deleteCar(userId, carId);
		ResponseStructure<Car> responseStructure = new ResponseStructure<>();
		if (deletedCar != null) {
